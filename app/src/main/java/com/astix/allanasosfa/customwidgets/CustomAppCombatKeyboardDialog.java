...
public class CustomAppCombatKeyboardDialog {
...
//            View focusCurrent = mHostActivity.getWindow().getCurrentFocus();
            if( mEditText==null || mEditText.getClass()!= AppCompatEditText.class) return;
    ...
    public CustomAppCombatKeyboardDialog(AppCompatActivity host, View rootView, int viewid, int layoutid) {
        mHostActivity= host;
        ...
        mKeyboardViewNum= (KeyboardView)mRootView.findViewById(viewid);
        ...
        mKeyboardViewNumWithoutDecimal= (KeyboardView)mRootView.findViewById(viewid);
