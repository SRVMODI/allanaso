...
public class DistributorMapActivity extends BaseActivity implements LocationInterface,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener,OnMapReadyCallback, Camera.PictureCallback
{
    ...
    public void locationRetrievingAndDistanceCalculating()
    {
        ...
        llaaa.locationRetrievingAndDistanceCalculating(DistributorMapActivity.this,false, true, 20, 0);
...
/*
    ...
    private class FullSyncDataNow extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            newfullFileName= CommonInfo.imei+"."+ TimeUtils.getNetworkDateTime(DistributorMapActivity.this,TimeUtils.DATE_TIME_FORMAT);;
